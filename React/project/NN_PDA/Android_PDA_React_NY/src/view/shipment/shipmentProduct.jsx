...
const PROC_PK_PDA_DV01_2_S = 'U_PK_PDA_DV01_2_S'; // 출하목록임시저장
...
const PROC_PK_PDA_DV01_4_S = 'U_PK_PDA_DV01_4_S'; // 출하저장
const PROC_PK_PDA_DV01_3_S = 'U_PK_PDA_DV01_3_S'; // 출하확정
 ...
 */
    ...
    const ReadData = (e) => {
        ...
        if (type === 'GET_WIFI_CURRENT_SIGNAL_STRENGTH') {
            ...
            //나중에 on/off 할 수 있게 수정
            // wifi 신호가 약할때
            if (wifiCurrentSignalStrength <= -85) {
                //신호값 기준 (전역)변수로 담아서 체크
                // 출하지시 Tabs
