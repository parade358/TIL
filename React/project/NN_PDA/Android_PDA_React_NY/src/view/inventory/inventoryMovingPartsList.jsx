...
const PROC_PK_PDA_REALIV02_2_D = 'U_PK_PDA_RealIV02_2_D'; // 화면 초기 로드시 쓰레기 데이터 삭제
const PROC_PK_PDA_REALIV02_1_L = 'U_PK_PDA_RealIV02_1_L'; // 현재창고 조회
const PROC_PK_PDA_REALIV02_2_L = 'U_PK_PDA_RealIV02_2_L'; // 현재위치 조회
const PRCO_PK_PDA_REALIV02_3_L = 'U_PK_PDA_RealIV02_3_L'; // 이동위치 조회
const PROC_PK_PDA_REALIV02_6_L = 'U_PK_PDA_RealIV02_6_L'; // 위치 바코드 검증 (현재위치)
const PROC_PK_PDA_REALIV02_7_L = 'U_PK_PDA_RealIV02_7_L'; // 위치 바코드 검증 (이동위치)
const PROC_PK_PDA_REALIV02_4_L = 'U_PK_PDA_RealIV02_4_L'; // 현재정보 조회 (바코드 스캔)
const PROC_PK_PDA_REALIV02_1_S = 'U_PK_PDA_RealIV02_1_S'; // 목록 저장 + 이동위치 사용처리 (리스트 데이터 추가)
const PROC_PK_PDA_REALIV02_1_D = 'U_PK_PDA_RealIV02_1_D'; // 목록 삭제 + 이동위치 사용해제처리 (리스트 데이터 삭제)
const PROC_PK_PDA_REALIV02_3_S = 'U_PK_PDA_RealIV02_3_S'; // 이동확정
const PROC_PK_PDA_REALIV02_5_L = 'U_PK_PDA_RealIV02_5_L'; // 처리이력 조회
...
function InventoryMovingPartsList() {
    ...
    const loadCurrentStorage = () => {
        const requestOption = getRequestOptions(PROC_PK_PDA_REALIV02_1_L, getRequestParam(pda_plant_id));
    ...
    const eventhandler = {
        ...
        onRadio1Changed: (e) => {
            ...
            if (gubun === 'select') {
                ...
                currentLocationStorageRef.current.value = '';
                setSelectedComboBoxCurrentLocationStorage(comboBoxCurrentLocationStorageRef.current[0]);
        ...
        onRadio2Changed: (e) => {
            ...
            if (gubun === 'select') {
                ...
                moveLocationStorageRef.current.value = '';
                setSelectedComboBoxMoveLocationStorage(comboBoxMoveLocationStorageRef.current[0]);
                scanLocationRef.current = 'moveLocation';
            }
    ...
    const test4 = () => {
        moveDateRef.current = '2024-05-29';
        loadProcessHistoryData();
    };
        ...
        <>
            <div className={classes.root}>
                ...
                <AcsTabPanel value={tabsValue} index={0}>
                    ...
                    <button onClick={test1}>현재창고조회</button>
                    <button onClick={test2}>현재위치조회</button>
                    <button onClick={test3}>이동위치조회</button>
                </AcsTabPanel>
                {/* ================================================================================== */}
                {/* 이동 */}
                ...
                <AcsTabPanel value={tabsValue} index={2}>
                    ...
                    <button onClick={test4}>처리내역조회</button>
                </AcsTabPanel>
                {/* ================================================================================== */}
...
export default InventoryMovingPartsList;
