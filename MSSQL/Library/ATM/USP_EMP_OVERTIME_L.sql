...
BEGIN   
	...
	--USERVIEW
         ...
         , FORMAT(START_OVERTIME, 'HH:mm')								'<ALIGN=CENTER;>시작시간'
         , FORMAT(END_OVERTIME, 'HH:mm')								'<ALIGN=CENTER;>종료시간'
         , DATEDIFF(MINUTE, START_OVERTIME, END_OVERTIME)				'<ALIGN=CENTER;>총 시간(분)'
