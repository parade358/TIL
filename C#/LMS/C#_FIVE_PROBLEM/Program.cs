using C__FIVE_PROBLEM;
using System;
using System.Linq;
using System.Text;

namespace C__FIVE_PROBLEM
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            __itrfDiffDateTime __ItrfDiffDateTime;
            ...
            __ItrfDiffDateTime = new DiffDateTime(dtStartDt, dtEndDt);
            ...
            */
            ...
            try
            {
                byte[] data3 = new byte[5] { 0x41, 0x42, 0x43, 0x45, 0x46 }; // 0x04는 EOT (End of Transmission) 문자를 나타냄
